...
<body>
    ...
    <div class="container">
        ...
        <h2>All Deleted Student List <a href="{{ route('student-add') }}" class="btn btn-sm btn-success">Add Student</a> 
            <a href="{{ route('student-list') }}" class="btn btn-sm btn-dark">Student List </a></h2>
                ...
                @foreach ($students as $student)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('student-deletedRestore',['id' =>$student->id])}}" class="btn btn-sm btn-success">Restore</a>
                        </td>
                    </tr>
